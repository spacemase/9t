...
insert into 9t_Admin values (NULL,'Jensen','Mason','developer@example.com','developer','92429d82a41e930486c6de5ebda9602d55c39986',0,now(),now());

create table 9t_Dadascope(
dsID int unsigned not null auto_increment primary key,
dsMonth month,
dsYear year,
entries[12] int unsigned,
text_only boolean DEFAULT true
);

create table 9t_DadascopeEntry(
EntryID int unsigned not null auto_increment primary key,
entryMonth month,
entryYear year,
entrySign varchar(16),
entryText text DEFAULT '',
FileName varchar(32) DEFAULT '',
FileLocation varchar(128) DEFAULT ''
);

insert into 9t_Dadascope values (NULL,4,2009,entries[12],true);
insert into 9t_Dadascope values (NULL,5,2009,entries[12],true);
insert into 9t_Dadascope values (NULL,6,2009,entries[12],true);
insert into 9t_Dadascope values (NULL,8,2009,entries[12],false);
